...
class DieSkinDef {
  ...
  final int bodyArgb;
  final int inkArgb;
  const DieSkinDef(this.id, this.name, this.text,
...
const List<String> dieSkinsOrder = [
  'bone', 'embertide', 'frostbound', 'wychwood',
  'gilded', 'bloodstone', 'obsidian',
];

const Map<String, DieSkinDef> dieSkins = {
  'bone': DieSkinDef('bone', 'Bone',
      'Plain delver bone, worn smooth by a thousand throws.',
      costEmbers: 0, bodyArgb: 0xFFFFFFFF, inkArgb: 0xFF241407),
  'embertide': DieSkinDef('embertide', 'Embertide',
      'Dice warmed to a forge-glow that never quite fades.',
      costEmbers: 150, bodyArgb: 0xFFFFB878, inkArgb: 0xFF3A1404),
  'frostbound': DieSkinDef('frostbound', 'Frostbound',
      'Chipped from delve-ice that refuses to melt.',
      costEmbers: 150, bodyArgb: 0xFFA8C8F0, inkArgb: 0xFF102A4A),
  'wychwood': DieSkinDef('wychwood', 'Wychwood',
      'Carved from a tree that grew where no light reached.',
      costEmbers: 200, bodyArgb: 0xFFC8A8E8, inkArgb: 0xFF2E1048),
  'gilded': DieSkinDef('gilded', 'Gilded',
      'Every pip set in hammered gold leaf.',
      costEmbers: 300, bodyArgb: 0xFFF0D070, inkArgb: 0xFF4A3208),
  'bloodstone': DieSkinDef('bloodstone', 'Bloodstone',
      'Cut from the red stone that remembers every delver.',
      costEmbers: 300, bodyArgb: 0xFFE89090, inkArgb: 0xFF4A0E0E),
  'obsidian': DieSkinDef('obsidian', 'Obsidian',
      'Volcanic glass, black as the bottom of the delve.',
      costEmbers: 400, bodyArgb: 0xFF585868, inkArgb: 0xFFE8E0D0),
};
