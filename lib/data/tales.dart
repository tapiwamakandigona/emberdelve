...
const List<String> hearthTales = [
  ...
  'Fourteen keep this fire now. Kindler, warden, gambler, ascetic, '
      'peddler, tinker, flintwright, runesmith, bearer, mender, '
      'shieldwright, gilder, cutler, collier — the delve answers each '
      'differently.',
  ...
  'Fourteen chairs at this fire now, and the delve answers each one '
