...
const List<String> hearthTales = [
  ...
  'Thirteen keep this fire now. Kindler, warden, gambler, ascetic, '
      'peddler, tinker, flintwright, runesmith, bearer, mender, '
      'shieldwright, gilder, cutler — the delve answers each '
      'differently.',
  ...
  'Thirteen chairs at this fire now, and the delve answers each one '
