...
const List<String> hearthTales = [
  ...
  'Ten keep this fire now. Kindler, warden, gambler, ascetic, '
      'peddler, tinker, flintwright, runesmith, bearer, mender — the '
  ...
  'Ten chairs at this fire now, and the delve answers each one '
