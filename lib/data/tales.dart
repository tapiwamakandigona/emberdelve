...
const List<String> hearthTales = [
  ...
  'Eleven keep this fire now. Kindler, warden, gambler, ascetic, '
      'peddler, tinker, flintwright, runesmith, bearer, mender, '
      'shieldwright — the delve answers each differently.',
  ...
  'Eleven chairs at this fire now, and the delve answers each one '
