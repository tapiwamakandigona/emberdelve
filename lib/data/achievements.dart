...
const Map<String, AchievementDef> achievements = {
  ...
  'stoker_wins': AchievementDef(
    'stoker_wins',
    'The First Shovel',
    'Win a delve as the Stoker.',
    stat: 'char_wins',
    target: 1,
    param: 'stoker',
  ),
  'fifteen_ways_down': AchievementDef(
    'fifteen_ways_down',
    'Fifteen Ways Down',
  ...
  'lamplighter_wins': AchievementDef(
    'lamplighter_wins',
    "The Lamplighter's Flare",
    'Win a run as the Lamplighter.',
    stat: 'char_wins',
    param: 'lamplighter',
    target: 1,
  ),
  'twenty_ways_down': AchievementDef(
    'twenty_ways_down',
    'Twenty Ways Down',
    'Win a run with every one of the twenty delvers.',
    stat: 'delvers_cleared',
    target: 20,
  ),
  'farrier_wins': AchievementDef(
    'farrier_wins',
    "The Farrier's Fit",
    'Win a run as the Farrier.',
    stat: 'char_wins',
    param: 'farrier',
    target: 1,
  ),
  'twentyone_ways_down': AchievementDef(
    'twentyone_ways_down',
    'Twenty-One Ways Down',
    'Win a run with every one of the twenty-one delvers.',
    stat: 'delvers_cleared',
    target: 21,
  ),
  ...
  'codex_hundred': AchievementDef(
    'codex_hundred',
    'The Long Shelf',
    'Unseal 100 Codex entries.',
    stat: 'codex_unsealed',
    target: 100,
  ),
  'tales_forty': AchievementDef(
    'tales_forty',
    'Fireside Fixture',
    'Hear 40 hearth tales at rests.',
    stat: 'tales_heard',
    target: 40,
  ),
