...
const Map<String, HearthThemeDef> hearthThemes = {
  ...
  'ashrose': HearthThemeDef('ashrose', 'Ashrose',
      'A soft rose flame, coaxed from petal-ash.',
      costEmbers: 120, warmArgb: 0xFF6E2438, brightArgb: 0xFFE89CB0),
  'verdigris': HearthThemeDef('verdigris', 'Verdigris',
      'Green copperfire from the drowned mines.',
      costEmbers: 140, warmArgb: 0xFF1E5A38, brightArgb: 0xFF7FE0A8),
  'stormglass': HearthThemeDef('stormglass', 'Stormglass',
      'The grey-teal light of a storm sealed in glass.',
      costEmbers: 160, warmArgb: 0xFF2E4A56, brightArgb: 0xFF9CCAD8),
  'moonpale': HearthThemeDef('moonpale', 'Moonpale',
      'Cold silver fire that burns without heat.',
      costEmbers: 200, warmArgb: 0xFF3C4458, brightArgb: 0xFFD8E0F0),
  'duskwine': HearthThemeDef('duskwine', 'Duskwine',
      'The deep red of a sun already gone.',
      costEmbers: 240, warmArgb: 0xFF581626, brightArgb: 0xFFC05068),
  'saltflame': HearthThemeDef('saltflame', 'Saltflame',
      'Blue-green fire fed on old sea salt.',
      costEmbers: 280, warmArgb: 0xFF0E5450, brightArgb: 0xFF6FE8DC),
  'sunflare': HearthThemeDef('sunflare', 'Sunflare',
      'White-gold noonfire, too bright to stare at.',
      costEmbers: 340, warmArgb: 0xFF8A5A10, brightArgb: 0xFFFFF2B0),
  'voidcoal': HearthThemeDef('voidcoal', 'Voidcoal',
      'A black flame that gives off dark instead of light.',
      costEmbers: 400, warmArgb: 0xFF16121E, brightArgb: 0xFF5A4A8A),
};
