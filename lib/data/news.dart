...
const String currentAppVersion = '0.184.105';
...
const List<NewsEntryDef> newsEntries = [
  ...
  NewsEntryDef(
    ...
    lines: [
      'The Codex sets its lore in a larger hand with more air between the '
          'lines, and the section tabs along the top are now proper buttons: '
          'bigger under the thumb, and the one you are in stays lit.',
  ...
  NewsEntryDef(
    ...
    lines: [
      ...
      'Three new rooms, the Spoken Stones: a fair scale, a wall of '
          ...
          'Codex gains the four keystones\' own words, a page for the '
          'Ashmonger\'s stall and one for the Ledger itself. A '
  ...
  NewsEntryDef(
    ...
    lines: [
      'The Stoker\u2019s Proving joins the list \u2014 normal floors, '
          'big coals, thin skin, one seed worth learning.',
      'New honors to match: The First Shovel, and Fifteen Ways Down '
          'for those who win with every delver.',
      'The Proven now asks all twenty-three.',
    ],
  ),
  NewsEntryDef(
    version: '0.175.0',
    title: 'The Stoker',
    lines: [
      'A fifteenth chair at the fire: the Stoker arrives with three '
          'heavy Ember Dice \u2014 big coals, thrown whole.',
      'Find them in the delver picker once 1950 embers are banked.',
      'Thank you for delving with us.',
    ],
  ),
  NewsEntryDef(
    ...
    lines: [
      'Every scrolling screen now shows a soft fade where more waits '
          'past the edge \u2014 and none when everything fits.',
      'Nothing moved, nothing hides: the delve just tells you where '
          'it continues.',
      'Thank you for delving with us.',
    ],
  ),
  NewsEntryDef(
    ...
    lines: [
      'A thirteenth rank crowns the ladder: the Worldflame, far above '
          'the Everburn.',
      'Every mark you have already banked still counts toward it.',
      'Thank you for delving with us.',
    ],
  ),
  NewsEntryDef(
    version: '0.172.0',
    title: 'The Fourteenth Way',
    lines: [
      'The Collier\u2019s Proving joins the list \u2014 normal floors, '
          'a fully worked pool, one seed worth learning.',
      'New honors to match: The First Coal, and Fourteen Ways Down '
          'for those who win with every delver.',
      'The Proven now asks all twenty-two.',
    ],
  ),
  NewsEntryDef(
    version: '0.171.0',
    title: 'The Collier',
    lines: [
      'A fourteenth chair at the fire: the Collier arrives with every '
          'die already worked \u2014 a Blade, a Gilt, and a Mend.',
      'Find them in the delver picker once 1800 embers are banked.',
      'Thank you for delving with us.',
    ],
  ),
  NewsEntryDef(
    version: '0.170.0',
    title: 'The Thirteenth Way',
    lines: [
      'The Cutler\u2019s Proving joins the list \u2014 normal floors, '
          'two marks, one seed worth learning.',
      'New honors to match: The First Edge, and Thirteen Ways Down '
          'for those who win with every delver.',
      'The Proven now asks all twenty-one.',
    ],
  ),
  NewsEntryDef(
    version: '0.169.0',
    ...
    lines: [
      'A polish pass under the hood: over a hundred small rebuild '
          'costs trimmed so screens draw with less wasted work.',
      'Nothing moved, nothing renamed \u2014 the delve just burns a '
          'little steadier.',
      'Thank you for delving with us.',
    ],
  ),
  NewsEntryDef(
    ...
    title: 'The Cutler',
    lines: [
      'A thirteenth chair at the fire: the Cutler arrives with two '
          'different marks \u2014 one face cuts, one face holds.',
      'Find them in the delver picker once 1650 embers are banked.',
      'Thank you for delving with us.',
    ],
  ),
  NewsEntryDef(
    ...
    lines: [
      'Steadier polish under the hood, and a fairer moment to be asked '
          'what you think of the delve.',
      'As always: asked once, never during the tour, never for a reward.',
      'Thank you for delving with us.',
    ],
  ),
  NewsEntryDef(
    ...
    title: 'The Everburn',
    lines: [
      'A twelfth rank crowns the ladder: the Everburn, far above '
          'Firstflame.',
      'Every mark you have already banked still counts toward it.',
      'Thank you for delving with us.',
    ],
  ...
  NewsEntryDef(
    version: '0.165.0',
    title: 'The Fifth Cycle',
    lines: [
      'Ten new hearth tales \u2014 the bearer, the mender, the '
          'shieldwright and the gilder finally get theirs, then the '
          'ledger\u2019s slower coins.',
      'The first cycle still opens the Hearthgold vista, exactly as '
          'before.',
      'Thank you for delving with us.',
    ],
  ),
  NewsEntryDef(
    version: '0.164.0',
    title: 'The Amethyst Vein',
    lines: [
      'A twelfth vista: Amethyst. Win a delve with twelve different '
          'delvers and the deep turns vein-purple.',
      'Every earlier vista keeps its earned gate, as ever.',
      'Thank you for delving with us.',
    ],
  ),
  NewsEntryDef(
  ...
  NewsEntryDef(
    ...
    title: 'The Gilder',
    lines: [
      'A twelfth delver takes a chair: the Gilder arrives with gilt '
          'worked into BOTH Ember Dice sixes \u2014 the pouch itself '
          'pays coin.',
      'The first kit with two smith\u2019s marks: coin on the roll, '
          'not on the kill \u2014 the peddler\u2019s opposite pole.',
      'Thank you for delving with us.',
    ],
  ),
  NewsEntryDef(
  ...
  NewsEntryDef(
    ...
    lines: [
      'Deepening now introduces itself: the first rest fire where you '
          'hold a marked die explains the second strike, once, in one '
          'card.',
      'Nothing new to learn by heart \u2014 the delve teaches at the '
          'moment it matters, as ever.',
      'Thank you for delving with us.',
    ],
  ),
  NewsEntryDef(
    version: '0.159.0',
    title: 'The Eleventh Way',
    lines: [
      'The Shieldwright\u2019s Proving joins the fixed delves: one '
          'road that never changes, the deep Aegis against a measured '
          'floor.',
      'Two honors follow the new chair: The First Ward, and Eleven '
          'Ways Down. Earlier honors keep their earned prices.',
      'Thank you for delving with us.',
    ],
  ),
  NewsEntryDef(
  ...
  NewsEntryDef(
    ...
    lines: [
      'Two hearth colours join the shelf: Twiceflame, a magenta tempered '
          'a shade deeper, and Marshlight, a pale green off the fens.',
      'Cosmetic as ever — real prices up front, no effect on play.',
    ],
  ),
  NewsEntryDef(
    version: '0.156.0',
    title: 'The Deep Day',
    lines: [
      'A new trial joins the daily rotation: deepen a rune mark at a '
          'rest fire, and the day pays a small bonus.',
      'As every trial: a missed goal is silent and costs nothing.',
    ],
  ),
  NewsEntryDef(
    version: '0.155.0',
  ...
  NewsEntryDef(
    ...
    lines: [
      'A new trial joins the daily rotation: end the delve carrying two '
          'or more relics, and the day pays a small bonus.',
      'As every trial: a missed goal is silent and costs nothing.',
    ],
  ),
  NewsEntryDef(
    ...
    lines: [
      'A quiet new tip on the title screen teaches the shared delve — '
          'one card, once ever, only after your first win.',
      'Nothing about the daily changed: same seed for everyone, a '
          'skipped day is silent.',
    ],
  ),
  NewsEntryDef(
    version: '0.152.0',
    title: 'The Tenth Chair',
    lines: [
      'A new vista: Tenthfire — the delve in the warm light of a full '
          'company. Unlock every delver to earn it.',
      'Vistas repaint the delve itself. Earned by delving, never sold.',
    ],
  ),
  NewsEntryDef(
    version: '0.151.0',
    title: 'The Tenth Way',
    lines: [
      "The Mender's Proving joins the list: the Mender on normal "
          'floors, same seed and same road for everyone.',
      'Two honors follow the tenth chair: The First Stitch, and Ten '
          'Ways Down.',
    ],
  ),
  NewsEntryDef(
    ...
    title: 'The Mender',
    lines: [
      'A tenth delver joins the fire: the Mender, whose Deep Coal '
          'carries the Mend rune on its worst face — the roll every '
          'delver curses is the one that stitches.',
      'Ten chairs at the fire now. The company honors moved with the '
          'roster, as they always do.',
    ],
  ),
  NewsEntryDef(
    version: '0.149.0',
    title: 'The Tenth Fire',
    lines: [
      'The rank ladder grew a tenth fire: Mountainheart, above '
          'Deepfire Sovereign.',
      'Ranks only name what a profile has already banked — the new '
          'tier is a longer honest climb, never a reset.',
    ],
  ),
  NewsEntryDef(
    version: '0.148.0',
    title: 'The Taught Fire',
    lines: [
      'Death lines now teach the anvil: when to temper, and what an '
          'Aegis mark buys against an elite.',
      'Every death teaches something true — that rule now has a test.',
    ],
  ),
  NewsEntryDef(
    version: '0.147.0',
    title: 'The Marked Day',
    lines: [
      'A new trial joins the daily rotation: temper a die face at a '
          'rest fire, and the day pays a small bonus.',
      'As every trial: a missed goal is silent and costs nothing.',
    ],
  ),
  NewsEntryDef(
    ...
    title: 'The Ninth Way',
    lines: [
      'The Bearer\u2019s Proving joins the list: two dice on normal '
          'floors, and the Echo teaching the little one.',
      'New honors: Stone-Shouldered and Nine Ways Down.',
    ],
  ),
  NewsEntryDef(
    version: '0.145.0',
    title: 'The Bearer',
    lines: [
      'A ninth chair at the fire: the Bearer — the giant. TWO dice, '
          'one a Molten Core, an Iron Scale, and the smith\u2019s Echo '
          'already worked into the 12.',
      'Few rolls, grand promises. 1050 embers at the Ledger.',
    ],
  ),
  NewsEntryDef(
    version: '0.144.0',
    title: 'The Peddler\u2019s Shelf',
    lines: [
      'Two dice skins join the Ledger: Verdigris, old copper gone '
          'green, and Coppervein, raw from the cold seams.',
      'Pure cosmetics, as ever \u2014 faces, rolls and odds never '
          'change.',
    ],
  ),
  NewsEntryDef(
    ...
    lines: [
      'A new proving on the ascension ladder: the Kindler at '
          'Ascension 15, between the Tenth Rung and the summit.',
      'Thin air; every mistake costs.',
    ],
  ),
  NewsEntryDef(
    version: '0.142.0',
    title: 'The Written Marks',
    lines: [
      'The Codex gains THE MARKS: six pages on the temper runes, in '
          'the smith\u2019s own words.',
      'Fifteen embers a page, like the dice they are worked into.',
    ],
  ),
  NewsEntryDef(
    version: '0.141.0',
  ...
  NewsEntryDef(
    ...
    lines: [
      'Two new hearth colours: Anvilglow, red-hot iron \u2014 and '
          'Runefire, a violet flame that burns in marks.',
      'Hearth Keeper now honestly asks for all fourteen.',
    ],
  ),
  NewsEntryDef(
    version: '0.139.0',
    title: 'The Shown Anvil',
    lines: [
      'New delvers now meet the smith properly: one card, at the '
          'first fire where a temper waits, naming all six runes.',
      'Once ever, dismissed with a tap \u2014 the usual rules.',
    ],
  ),
  NewsEntryDef(
    version: '0.138.0',
    title: 'The Delver\u2019s Dice',
    lines: [
      'Die skins are worn per delver now \u2014 the warden can roll '
          'Tempered steel while the kindler keeps Bone.',
      'Dress them in the picker; the Ledger shelf still sells.',
    ],
  ),
  NewsEntryDef(
    version: '0.137.0',
    ...
    lines: [
      'Ten new hearth tales \u2014 this pass sits with the anvil and '
          'the calendar: the smith, the runes, the rules, the vistas.',
      'Forty tales in the telling now. The fire remembers them all.',
    ],
  ),
  NewsEntryDef(
    version: '0.136.0',
