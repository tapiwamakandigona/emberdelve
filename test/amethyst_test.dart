...
void main() {
  ...
  test(
    'amethyst holds the twelfth seat with a violet grade and a frozen gate',
    () {
      // v0.180.0: Obsidian appended after it; Amethyst keeps its twelfth seat.
      expect(vistasOrder[11], 'amethyst');
