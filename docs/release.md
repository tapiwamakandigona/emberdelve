...
| What | Where |
|---|---|
| Keystore (PKCS12, alias `emberdelve`, RSA-4096, valid to 2066) | sandbox: `/work/secrets/emberdelve-upload.keystore`; passwords + alias + cert fingerprint: `/work/secrets/emberdelve_signing.md` |
