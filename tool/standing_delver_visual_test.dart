...
// tool/standing_delver_visual_test.dart — manual visual-critique plates for
// v0.61.0 "The Deepest Mark". Not part of CI.
//
//   flutter test tool/standing_delver_visual_test.dart
//
// Plates (build/standing_delver_visual/):
...
const outDir = 'build/standing_delver_visual';
...
void main() {
  ...
  testWidgets('standing delver plates', (tester) async {
    await loadRealFonts();

    // Win: dyed kindler wearing a title, breathing above the headline.
    final win = GameController();
    win.meta
      ..runsWon = 1
      ..ownedDyes.add('emberwash');
    win.meta.charDye['kindler'] = 'emberwash';
    win.meta.charEpithet['kindler'] = 'the_delver';
    win.startRun(
      character: 'kindler',
      seed: 1,
      boons: true,
    ...
    await captureSummary(
      ...
      win,
      const Size(360, 640),
      'standing_win_360x640',
    );

    // Loss on the narrowest width: dimmed, still, bare name.
