...
// tool/charted_depth_visual_test.dart — manual visual-critique plates for
// v0.65.0 "The Charted Depth". Not part of CI.
//
//   flutter test tool/charted_depth_visual_test.dart
//
// Plates (build/charted_depth_visual/):
//   • charted_360x640 — picker top, veteran meta (all six delvers with mixed
//     records, worn epithet, big counts).
//   • charted_320x568 — the restraint plate: narrowest supported width with
//     the longest epithet ("the Well-Oiled") + four-digit tally.
//   • charted_fresh_360x640 — fresh install: no tally lines anywhere.
import 'dart:io';
...
const outDir = 'build/charted_depth_visual';
