// tool/coming_rule_visual_test.dart — manual visual-critique plates for
// v0.109.0 "The Coming Rule". Not part of CI.
//
//   flutter test tool/coming_rule_visual_test.dart
//
// Plates (build/coming_rule_visual/):
//   • rule_360x640 — the title weekly card after this week was played:
//     recap checkmark + 'Next Monday: <rule>' beneath it.
//   • rule_320x568 — restraint plate at the narrowest width.
import 'dart:io';
...
const outDir = 'build/coming_rule_visual';
...
void main() {
  testWidgets('coming rule plates', (tester) async {
