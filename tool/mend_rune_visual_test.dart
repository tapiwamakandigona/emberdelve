// tool/mend_rune_visual_test.dart — manual visual-critique plates for
// v0.124.0 "The Mender's Mark": the temper sheet's five-rune list with
// Mend CHOSEN, at two sizes. Not part of CI.
//
//   flutter test tool/mend_rune_visual_test.dart
import 'dart:io';
...
const outDir = 'build/mend_rune_visual';
...
void main() {
  for (final probe in <List<Object>>[
    ...
    testWidgets('temper sheet @ $label', (tester) async {
      ...
      await tester.scrollUntilVisible(
        find.byKey(const ValueKey('temper-rune-mend')),
        120,
      ...
      await _pump(tester, 3);
      await _shoot(tester, key, 'mend-$label');
