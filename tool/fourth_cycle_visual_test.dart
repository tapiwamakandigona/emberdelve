// tool/fourth_cycle_visual_test.dart — manual visual-critique plates
// for v0.137.0 "The Fourth Cycle": the rest fire telling the cycle's
// first tale (hearthTalesHeard=30). Not part of CI.
//
//   flutter test tool/fourth_cycle_visual_test.dart
import 'dart:io';
...
const outDir = 'build/fourth_cycle_visual';
...
GameController _atRest() {
  ...
  c.meta.hearthTalesHeard = 30; // first fourth-cycle tale tells next
