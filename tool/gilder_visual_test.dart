// tool/gilder_visual_test.dart — manual visual-critique plates for
// v0.162.0 "The Gilder": the delver picker scrolled to the gilder's
// card (sprite, kit line, price). Not part of CI.
//
//   flutter test tool/gilder_visual_test.dart
import 'dart:io';
...
const outDir = 'build/gilder_visual';
...
Future<void> capture(
  ...
  await tester.scrollUntilVisible(
    find.text('The Gilder'),
    400,
    scrollable: scrollable,
    maxScrolls: 100,
  );
  await tester.pump(const Duration(milliseconds: 100));
  final rowTop = tester.getTopLeft(find.text('The Gilder')).dy;
