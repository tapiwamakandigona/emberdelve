// tool/eighth_way_visual_test.dart — manual visual-critique plates for
// v0.136.0 "The Eighth Way": the provings screen scrolled to the
// Runesmith's Proving (unlocked delver, locked proving with its
// delve-code line). Not part of CI.
//
//   flutter test tool/eighth_way_visual_test.dart
import 'dart:io';
...
const outDir = 'build/eighth_way_visual';
...
void main() {
  testWidgets('proven rules plates', (tester) async {
    ...
    GameController rulesMeta() {
      ...
      c.meta.unlockedCharacters.addAll({'warden', 'runesmith'});
    ...
    await plateScreen(
      ...
      rulesMeta(),
      'eighth_360x640',
      scrollToKey: 'proving-start-runesmiths_proving',
      backDrag: 200,
    );
    await plateScreen(
      tester,
