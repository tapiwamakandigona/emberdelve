// tool/proven_rules_visual_test.dart — manual visual-critique plates for
// v0.108.0 "The Proven Rules". Not part of CI.
//
//   flutter test tool/proven_rules_visual_test.dart
//
// Plates (build/proven_rules_visual/):
...
const outDir = 'build/proven_rules_visual';
...
void main() {
  testWidgets('proven rules plates', (tester) async {
    ...
    GameController rulesMeta() {
      ...
      c.meta.unlockedCharacters.addAll({'warden', 'gambler'});
      c.meta.provingsCleared.add('flint_proving');
      return c;
    }
    ...
    await plateScreen(
      ...
      rulesMeta(),
      'rules_360',
      scrollToKey: 'proving-start-cold_proving',
      backDrag: 200,
    );
    await plateScreen(
      tester,
