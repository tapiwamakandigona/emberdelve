// tool/third_cycle_visual_test.dart — manual visual-critique plates for
// v0.120.0 "The Third Cycle". Not part of CI.
//
//   flutter test tool/third_cycle_visual_test.dart
//
// Plates (build/third_cycle_visual/):
//   • cycle_360x640 — the rest fire telling the doubled-week tale (the
//     third cycle's first): heard=20 profile mid-arc.
//   • cycle_320x568 — the winter tale (heard=21) at the narrowest width.
import 'dart:io';
...
const outDir = 'build/third_cycle_visual';
...
void main() {
  ...
  testWidgets('third cycle plates', (tester) async {
    await tester.binding.runAsync(loadRealFonts);
    addTearDown(tester.view.reset);
    await captureRest(tester, const Size(360, 640), 'cycle_360x640', heard: 20);
    await captureRest(tester, const Size(320, 568), 'cycle_320x568', heard: 21);
  });
}
