// tool/mender_visual_test.dart — manual visual-critique plates for
// v0.150.0 "The Mender": the delver picker scrolled to the mender's
// card (sprite, kit line, price). Not part of CI.
//
//   flutter test tool/mender_visual_test.dart
import 'dart:io';
...
const outDir = 'build/mender_visual';
...
Future<void> capture(
  ...
  await tester.scrollUntilVisible(
    find.text('The Mender'),
    400,
    scrollable: scrollable,
    maxScrolls: 100,
  );
  await tester.pump(const Duration(milliseconds: 100));
  final rowTop = tester.getTopLeft(find.text('The Mender')).dy;
