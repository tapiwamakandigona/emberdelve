...
// tool/new_song_visual_test.dart — manual visual-critique plates for
// v0.76.0 "The New Song". Not part of CI.
//
//   flutter test tool/new_song_visual_test.dart
//
// Plates (build/new_song_visual/):
//   • new_song_360x640 — a first win: the collapsed '"…" and N more join
//     the Gramophone' line sits with the firsts-line, quiet and unclipped.
//   • new_song_320x568 — the restraint plate: narrowest supported width,
...
const outDir = 'build/new_song_visual';
...
Future<void> captureSummary(
  ...
  await tester.scrollUntilVisible(
    find.byKey(const ValueKey('new-song-line')),
    -200,
...
void main() {
  ...
  testWidgets('new song plates', (tester) async {
    await loadRealFonts();
