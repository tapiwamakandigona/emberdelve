// temp plate: loss summary with named-foe row at 320 (1.0x and 1.3x), plus
// the codex after the tap.
import 'dart:io';
...
const outDir = 'build/named_foe_visual';
...
void main() {
  ...
  for (final scale in [1.0, 1.3]) {
    testWidgets('named foe plates $scale', (tester) async {
      ...
      await shoot(tester, key, 'summary_named_foe_320_$tag');
      await tester.tap(row);
      await pumpFor(tester, 6000);
      await shoot(tester, key, 'codex_at_killer_320_$tag');
    });
  }
}
