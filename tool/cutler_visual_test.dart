// tool/cutler_visual_test.dart — manual visual-critique plates for
// v0.168.0 "The Cutler": the delver picker scrolled to the cutler's
// card (sprite, kit line, price). Not part of CI.
//
//   flutter test tool/cutler_visual_test.dart
import 'dart:io';
...
const outDir = 'build/cutler_visual';
...
Future<void> capture(
  ...
  await tester.scrollUntilVisible(
    find.text('The Cutler'),
    400,
    scrollable: scrollable,
    maxScrolls: 100,
  );
  await tester.pump(const Duration(milliseconds: 100));
  final rowTop = tester.getTopLeft(find.text('The Cutler')).dy;
