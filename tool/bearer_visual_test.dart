// tool/bearer_visual_test.dart — manual visual-critique plates for
// v0.145.0 "The Bearer": the delver picker scrolled to the bearer's
// card (sprite, kit line, price). Not part of CI.
//
//   flutter test tool/bearer_visual_test.dart
import 'dart:io';
...
const outDir = 'build/bearer_visual';
...
Future<void> capture(
  ...
  await tester.scrollUntilVisible(
    find.text('The Bearer'),
    400,
    scrollable: scrollable,
    maxScrolls: 100,
  );
  await tester.pump(const Duration(milliseconds: 100));
  final rowTop = tester.getTopLeft(find.text('The Bearer')).dy;
