// tool/flintwright_visual_test.dart — manual visual-critique plates for
// v0.118.0 "The Flintwright" (7th delver). Not part of CI.
//
//   flutter test tool/flintwright_visual_test.dart
//
// Plates (build/flintwright_visual/):
//   • flint_card_360x640 — the picker scrolled to the Flintwright: flint
//     grey-tan sheet, four-shard kit line, Knapping Pick, honest price.
//   • flint_card_320x568 — restraint plate at the narrowest width.
import 'dart:io';
...
const outDir = 'build/flintwright_visual';
...
Future<void> capture(
  ...
  await tester.scrollUntilVisible(
    find.text('The Flintwright'),
    400,
    scrollable: scrollable,
    maxScrolls: 100,
  );
  await tester.pump(const Duration(milliseconds: 100));
  final rowTop = tester.getTopLeft(find.text('The Flintwright')).dy;
