// tool/seventh_way_visual_test.dart — manual visual-critique plates for
// v0.119.0 "The Seventh Way". Not part of CI.
//
//   flutter test tool/seventh_way_visual_test.dart
//
// Plates (build/seventh_way_visual/):
...
const outDir = 'build/seventh_way_visual';
...
void main() {
  testWidgets('proven rules plates', (tester) async {
    ...
    GameController rulesMeta() {
      ...
      c.meta.unlockedCharacters.addAll({'warden', 'flintwright'});
    ...
    await plateScreen(
      ...
      rulesMeta(),
      'seventh_360x640',
      scrollToKey: 'proving-start-flintwrights_proving',
      backDrag: 200,
    );
    await plateScreen(
      tester,
