// tool/ninth_way_visual_test.dart — manual visual-critique plates for
// v0.146.0 "The Ninth Way": the provings screen scrolled to the
// bearer's proving with its delve-code line. Not part of CI.
//
//   flutter test tool/ninth_way_visual_test.dart
import 'dart:io';
...
const outDir = 'build/ninth_way_visual';
...
void main() {
  testWidgets('proven rules plates', (tester) async {
    ...
    GameController rulesMeta() {
      ...
      c.meta.unlockedCharacters.addAll({'warden', 'bearer'});
    ...
    await plateScreen(
      ...
      rulesMeta(),
      'ninth_360x640',
      scrollToKey: 'proving-start-bearers_proving',
      backDrag: 200,
    );
    await plateScreen(
      tester,
