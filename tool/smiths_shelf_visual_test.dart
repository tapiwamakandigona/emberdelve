// tool/smiths_shelf_visual_test.dart — manual visual-critique plates for
// v0.128.0 "The Smith's Shelf". Not part of CI.
//
//   flutter test tool/smiths_shelf_visual_test.dart
//
// Plates (build/smiths_shelf_visual/):
...
const outDir = 'build/smiths_shelf_visual';
...
void main() {
  ...
  testWidgets('smiths shelf plates', (tester) async {
    await loadRealFonts();
    await capture(
      tester,
      deepMeta(),
      const Size(360, 640),
      'forgesoot_360x640',
      scrollTo: const ValueKey('dye-forgesoot'),
    );
    await capture(
      tester,
      deepMeta(),
